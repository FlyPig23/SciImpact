"""
Run Hugging Face dataset card download-prediction evals for local fine-tuned models with vLLM.
"""
...
MODELS: list[ModelSpec] = [
    ModelSpec(
        ...
        "llama",
        "llama32_sft_vllm_datasetcard_results.json",
    ),
    ModelSpec(
        "../LLaMA-Factory/saves/Qwen3-4B_Paper_Impact_SFT",
        "qwen",
        "qwen3_sft_vllm_datasetcard_results.json",
    ),
    ModelSpec(
        "../LLaMA-Factory/saves/Qwen3-4B_Paper_Impact_SFT_1ep",
        "qwen",
        "qwen3_sft_vllm_datasetcard_1ep_results.json",
    ),
]

"""
Run Hugging Face model card download-prediction evals for a list of models with vLLM, one model at a time.

- Uses visible GPUs (default: 1,3) with tensor parallelism set to 2 and GPU memory util 0.80.
- Models and output files are defined in the MODELS list; add/remove to change coverage.
"""
...
MODELS: list[ModelSpec] = [
    ModelSpec("meta-llama/Meta-Llama-3-8B-Instruct", "llama", "llama3_vllm_modelcard_results.json"),
    ModelSpec("meta-llama/Llama-3.1-8B-Instruct", "llama", "llama31_vllm_modelcard_results.json"),
    ModelSpec("meta-llama/Llama-3.2-3B-Instruct", "llama", "llama32_vllm_modelcard_results.json"),
    # ModelSpec("Qwen/Qwen3-4B-Instruct-2507", "qwen", "qwen3_vllm_modelcard_results.json"),
    ModelSpec("Qwen/Qwen2.5-7B-Instruct", "qwen", "qwen25_7b_vllm_modelcard_results.json"),
    ModelSpec("Qwen/Qwen2.5-14B-Instruct", "qwen", "qwen25_14b_vllm_modelcard_results.json"),
    ModelSpec(
        "mistralai/Ministral-3-3B-Instruct-2512",
        "mistral",
        "ministral3_3b_vllm_modelcard_results.json",
        llm_kwargs={"tokenizer_mode": "mistral", "config_format": "mistral", "load_format": "mistral"},
    ),
    ModelSpec(
        "nvidia/NVIDIA-Nemotron-3-Nano-30B-A3B-FP8",
        "nemotron",
        "nemotron3_vllm_modelcard_results.json",
        llm_kwargs={
            "kv_cache_dtype": "fp8",
        },
        env_vars={

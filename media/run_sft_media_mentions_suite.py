"""
Run media-mentions impact pair evals for local fine-tuned models with vLLM.
"""
...
MODELS: list[ModelSpec] = [
    ModelSpec(
        ...
        "llama",
        "llama32_sft_vllm_media_mentions_results.json",
    ),
    ModelSpec(
        "../LLaMA-Factory/saves/Qwen3-4B_Paper_Impact_SFT",
        "qwen",
        "qwen3_sft_vllm_media_mentions_results.json",
    ),
    ModelSpec(
        "../LLaMA-Factory/saves/Qwen3-4B_Paper_Impact_SFT_1ep",
        "qwen",
        "qwen3_sft_vllm_media_mentions_1ep_results.json",
    ),
]
...
def run_model(spec: ModelSpec, hf_token: str, output_dir: Path) -> dict:
    ...
    return {
        ...
        "accuracy": accuracy,
        "elapsed_seconds": None,  # filled in main
